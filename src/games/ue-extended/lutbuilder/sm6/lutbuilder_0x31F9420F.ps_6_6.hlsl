...
float4 main(
  ...
  float _68 = (exp2(((float((uint)(int)(SV_RenderTargetArrayIndex)) / _21) + -0.4340175986289978f) * 14.0f) * 0.18000000715255737f) + -0.002667719265446067f;
  bool _95 = (bIsTemperatureWhiteBalance != 0);
  ...
  float _361 = (1.0f - exp2(((_343 * _343) * -4.0f) * 0.f)) * (1.0f - exp2(dot(float3(_347, _348, _349), float3(_347, _348, _349)) * -4.0f));
  ...
  SV_Target = ProcessLutbuilder(float3(_744, _746, _748), Samplers_1, Samplers_2, Samplers_3, Textures_1, Textures_2, Textures_3, cb_config, SV_Target, OutputDevice);
  return SV_Target;
}
